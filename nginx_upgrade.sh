...
sudo touch /etc/nginx/conf.d/default1.conf
sudo touch /etc/nginx/sites-enabled/default1.conf
sudo touch /etc/nginx/sites-available/default1.conf
sudo rm -r /etc/nginx/conf.d/*
sudo rm -r /etc/nginx/sites-enabled/*
sudo rm -r /etc/nginx/sites-available/*
sudo touch /var/www/default1.conf
sudo rm -r /var/www/*
