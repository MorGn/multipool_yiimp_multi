...
define('"'"'NICEHASH_DEPOSIT'"'"','"'"'16x9dQBFmpGRBd9dLLLCyKYh5Fqu63WwMx'"'"');
define('"'"'NICEHASH_DEPOSIT_AMOUNT'"'"','"'"'0.01'"'"');

$cold_wallet_table = array(
'"'"'16x9dQBFmpGRBd9dLLLCyKYh5Fqu63WwMx'"'"' => 0.10,
);
